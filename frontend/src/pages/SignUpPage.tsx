...
const SignUpPage = () => {
  ...
  return (
    <div className="relative h-screen max-h-screen bg-background text-foreground transition-colors duration-300 flex flex-col justify-between overflow-hidden font-sans">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-purple-500/15 blur-[120px] rounded-full pointer-events-none -z-10" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-indigo-500/15 blur-[120px] rounded-full pointer-events-none -z-10" />
